...
?>
    <div class="epa_options_page wrap">
        ...
        <form method="post" action="options.php">
            ...
            <p><?php _e('General Setting for popup','easy-popup-announcement');?></p>
            <table class="form-table">
				...
				<tr valign="top">
					...
					<td>
						<fieldset>
							<input type="text" name="epa_bgcolor" size="45" class="epa_popup_bgcolor" data-default-color="#000000" value="<?php echo get_option('epa_bgcolor'); ?>" />
						</fieldset>
					</td>
				</tr>
                <tr valign="top">
